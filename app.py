...
# ============================================================
#
# Idades em Ma antes do presente.
# A referência numérica geral da história da Terra usada para a
# proporção é 4,54 Ga (4540 Ma).
#
# Os limites abaixo seguem, de forma simplificada para fins
# didáticos, a escala internacional atual (ICS), mantendo a
# classificação em Éon -> Era -> Período.
# ============================================================
...
# ao intervalo geológico encontrado pelo cálculo. Eles não são
# tratados como se tivessem ocorrido exatamente no instante do
# filme/partida. As idades são aproximadas e têm finalidade
# didática.
# ============================================================
...
DESTAQUES = {
    ...
    "Eoarqueano": [
        ("Primeiros registros de vida", "As evidências mais antigas de vida e de atividade biológica aparecem no Arqueano."),
    ...
    "Paleoproterozoico": [
        ...
        ("Diversificação dos eucariotos", "As primeiras evidências de células eucarióticas aparecem no registro geológico do Proterozoico."),
        ("Transformação dos oceanos", "O aumento do oxigênio alterou profundamente a química dos ambientes marinhos."),
    ],

    "Mesoproterozoico": [
        ("Diversificação dos eucariotos", "Organismos eucarióticos tornaram-se mais importantes nos ecossistemas."),
    ...
    "Ordoviciano": [
        ...
        ("Primeiros peixes com mandíbulas", "A história inicial dos vertebrados continuou com importantes inovações evolutivas."),
...
st.title("ESCALA GEOCINÉFILA")

st.markdown(
    """

    Uma representação proporcional da história da Terra através da duração
    de um evento ou produção audiovisual. Veja o que está acontecendo na
    história da Terra em determinado momento do filme, série ou partida esportiva!
    """
)
...
tab_sobre, tab_referencias, tab_codigo = st.tabs(["SOBRE A ESCALA GEOCINÉFILA", "REFERÊNCIAS", "ACESSO AO CÓDIGO FONTE"])
...
with tab_codigo:
    ...
    st.info("O acesso público ao código ainda está em preparação. O link será adicionado aqui quando o repositório estiver disponível.")
...
st.caption(
    "Escala Geocinéfila — representação didática do tempo geológico."
)
